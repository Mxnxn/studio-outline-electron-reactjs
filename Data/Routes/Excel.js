...
app.post("/generate", async (req, res) => {
    try {
        ...
        Obj.longNotesWithIndex(endRow+2,{value: "Payment term includes 50% advance,45% on middle of the project and 5% after completion of project",index:"2)"}, true);
        ...
        Obj.longNotes(endRow+4, "THIS FILE IS THE PROPERTY OF STUDIO OUTLINE - INTERIOR DESIGNERS & MUST BE RETURNED ON REQUEST. IT IS SUBMITED AS CONFIDENTIAL INFORMATION IN CONNECTION WITH THE ENQUIRY, TENDER OR CONTRACT. IT IS NOT BE USED FOR ANY OTHER PURPOSES OR NOR MAY IT BE COPIED OR LENT WITHOUT OUR AUTHORITY IN WRITING.", true);
